...
This code contains an implementation of a 4-ary Merkle Tree for verifying data integrity. The tree uses FNV1a hashing for consistent results across platforms. Each leaf node contains the hash of individual data points, and internal nodes contain hashes of their child nodes. The root node serves as the fingerprint for the entire tree.
